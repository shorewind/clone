...
const hintDisplay = document.querySelector('.message-container')
...
const hintClick = () => {
    ...
    fetch(`https://api.datamuse.com/words?ml=${wordle}`)
...
const checkRow = () => {
    ...
    const lowered_guess = guess.toLowerCase()
    function inArray (word_list, lowered_guess) {
        return word_list.includes(lowered_guess)
    }
    if (currentTile > 4) {
